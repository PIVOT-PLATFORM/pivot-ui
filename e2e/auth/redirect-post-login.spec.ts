 ...
 *
 * Couverture :
 * 1. Happy path — un utilisateur non authentifié tente /account/profile, est renvoyé
 *    au login, puis est redirigé vers /account/profile après authentification.
...
test.describe('US01.1.4 — Redirection post-login', () => {
  ...
  // -------------------------------------------------------------------------
  test('accès à /account/profile non authentifié → login → redirection vers /account/profile', async ({
    page,
    context,
  }) => {
