 ...
 *
 * @pivot/design-system EN17.8 — version lib indépendante de l'app.
 * Importe PasswordPolicyService depuis la lib (pas depuis app/core/auth/).
 *
 * - Barre de force + texte du niveau visible (WCAG 1.4.1)
 * - Checklist des critères de la politique backend, cochés en temps réel
 * - Niveau annoncé via aria-live="polite"
 */
@Component({
  selector: 'pivot-ds-password-strength',
  standalone: true,
