...
@Component({
	// PIVOT-vendored: selector ajouté (le plugin de test Analog refuse les composants sans
	// selector ; instancié par ComponentPortal, le selector n'a aucun effet fonctionnel).
